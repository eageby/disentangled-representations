...
@click.option('--path', type=click.Path(dir_okay=True, writable=True), default=None, callback=path_callback, help='Save')
@click.option('--checkpoint', type=click.Path(dir_okay=True, readable=True), default=None, callback=path_callback)
