...
gin.external_configurable(tf.keras.layers.Conv2DTranspose, 'tf.keras.layers.Conv2DTranspose')

gin.external_configurable(tf.data.Dataset.shuffle, 'tf.data.Dataset.shuffle')

gin.external_configurable(tf.keras.callbacks.TensorBoard, 'tf.keras.callbacks.TensorBoard')
