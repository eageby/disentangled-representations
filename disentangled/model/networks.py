...
def discriminator(latents, activation):
    return tf.keras.Sequential(
        [
            tf.keras.layers.Dense(1000, activation=activation, input_shape=(latents,)),
...
gin.constant("disentangled.model.networks.conv_4_transpose_padded", conv_4_transpose_padded)
